...
/*
 ********************************************
 * Modified by Sven Pfiffner on 07.11.2019	*
 * to work with the TreeDrawer class		*
 ********************************************
 */
...
public class GraphViz
{
    ...
    private byte[] get_img_stream(File dot, String type)
    {
        ...
        try {
            img = File.createTempFile("graph_", "."+type, new File(TreeDrawer.TEMP_DIR));
            Runtime rt = Runtime.getRuntime();

            // patch by Mike Chenault
            String[] args = {TreeDrawer.DOT_LOC, "-T"+type, "-Gdpi="+dpiSizes[this.currentDpiPos], dot.getAbsolutePath(), "-o", img.getAbsolutePath()};
            ...
            System.err.println("Error:    in I/O processing of tempfile in dir " + TreeDrawer.TEMP_DIR+"\n");
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException
    {
        File temp;
        try {
            temp = File.createTempFile("dorrr",".dot", new File(TreeDrawer.TEMP_DIR));
